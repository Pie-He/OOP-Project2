...
/*
		final MFrameS frame = new MFrameS();
	...
	class PlacePanel extends JPanel {
		private ImageIcon ico = new ImageIcon("picture/起点.jpg");
		...
		protected void paintComponent(Graphics g) {
			...
			g.drawString("经过起点", 20, 20);
			g.setFont(new Font("隶书", Font.PLAIN, 30));
			g.drawString("奖励2000", 5, 50);
		}
	}*/
}

/*class MFrameS extends JFrame {
	MFrameS() {
		setSize(400, 200);
